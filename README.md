...
- Dotted recent model values bridging the archive to a low, mean, and high forecast on the annual chart, an interactive tooltip, a calendar table that starts at today's date and labels recent model estimates for days awaiting archived data, and a Celsius/Fahrenheit switch.
